...
<body onload="doAutoLogin();">
	<form id="credentials" method="POST"
		...
		<input type="hidden" name="lt" value="${loginTicket}" /> <input
			...
			name="username" value="<%=request.getParameter("username")%>" /> <input
...
<body>
	<div class="login_box">
		...
		<form action="/cas/login?${xquery}&locale=zh_CN" method="post"
			id="login_form">
			...
			<div class="cnt_b">
				<div class="form-group">
					<div class="input-group">
						...
						</span> <input class="form-control input-sm" type="text" id="username"
				...
				<div class="form-group">
					<div class="input-group">
						...
						</span> <input class="form-control input-sm" type="password"
